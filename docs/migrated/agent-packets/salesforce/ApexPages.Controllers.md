# Salesforce Surface Packet: UI.ApexPagesControllers

- Area: UI.ApexPagesControllers
- Owner: internal/vm ApexPages
- Ledger row filter: `product=apex namespace=ApexPages`
- Ratchet target: UI.ApexPagesControllers missing rows do not increase
...
- `internal/vm/platform_apexpages*.go`
...
- `ApexPages Controllers focused compatibility fixture or explicit unsupported fixture`
