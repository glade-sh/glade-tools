# Salesforce Surface Packet: Server.RESTResources

- Area: Server.RESTResources
- Owner: internal/server
- Ledger row filter: `product=rest`
- Ratchet target: Server.RESTResources missing rows do not increase
...
- `REST Resources focused compatibility fixture or explicit unsupported fixture`
