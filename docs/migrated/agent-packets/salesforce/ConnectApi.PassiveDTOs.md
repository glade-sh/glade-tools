# Salesforce Surface Packet: ConnectApi.PassiveDTOs

- Area: ConnectApi.PassiveDTOs
- Owner: internal/vm passive members
- Ledger row filter: `product=connect-rest-api passive DTO rows`
- Ratchet target: ConnectApi.PassiveDTOs missing rows do not increase
...
- `ConnectApi Passive DTOs focused compatibility fixture or explicit unsupported fixture`
