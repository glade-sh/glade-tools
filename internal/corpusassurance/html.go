...
func renderAssuranceHTML(report []byte) ([]byte, error) {
	...
	page := "<!doctype html><html lang=\"en\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><title>Glade assurance</title>" +
		"<style>*{box-sizing:border-box}body{font:14px system-ui;margin:2rem;overflow-wrap:anywhere}.filters{display:flex;flex-wrap:wrap;gap:.4rem}label{display:grid;gap:.2rem}input,select{padding:.5rem;min-width:12rem;max-width:100%}.table-scroll{max-width:100%;overflow-x:auto}table{border-collapse:collapse;width:max-content;min-width:100%;margin-top:1rem}td,th{border:1px solid #ddd;padding:.4rem;text-align:left}@media(max-width:600px){body{margin:1rem}}</style></head><body>" +
		"<h1>Glade assurance</h1><p>Filter the sealed surface rows by namespace, disposition, repository, evidence, exclusion, or text.</p><div class=\"filters\"><label>Namespace<select id=\"namespace\"><option value=\"\">All namespaces</option></select></label><label>Disposition<select id=\"disposition\"><option value=\"\">All dispositions</option></select></label><label>Repository<select id=\"repository\"><option value=\"\">All repositories</option></select></label><label>Evidence<select id=\"evidence\"><option value=\"\">All evidence</option></select></label><label>Exclusion<select id=\"exclusion\"><option value=\"\">All exclusions</option></select></label><label>Search<input id=\"text\" placeholder=\"Surface or usage\"></label></div><div class=\"table-scroll\" role=\"region\" aria-label=\"Surface assurance table\" tabindex=\"0\"><table><thead><tr><th>Surface</th><th>Repositories</th><th>Disposition</th><th>Local</th><th>Salesforce</th><th>Readiness</th><th>Non-parity</th></tr></thead><tbody id=\"rows\"></tbody></table></div><h2>Repository × surface</h2><div class=\"table-scroll\" role=\"region\" aria-label=\"Repository surface table\" tabindex=\"0\"><table><thead><tr><th>Repository</th><th>Surface</th><th>Compile</th><th>Test</th><th>Runtime parity</th><th>Readiness</th><th>Non-parity</th></tr></thead><tbody id=\"repository-rows\"></tbody></table></div><h2>Repository summaries</h2><div class=\"table-scroll\" role=\"region\" aria-label=\"Repository summary table\" tabindex=\"0\"><table><thead><tr><th>Repository</th><th>Surfaces</th><th>Compile</th><th>Test</th><th>Runtime parity</th><th>Non-parity</th></tr></thead><tbody id=\"repository-summaries\"></tbody></table></div>" +
