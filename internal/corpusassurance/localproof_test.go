...
func TestCoreRuntimeFixturesAreFullyCandidateRunnable(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"data-database-delete-undelete-object-runtime.json", 7},
		{"data-database-delete-undelete-object-system-mode-runtime.json", 6},
		...
		{"data-database-batch-boolean-runtime.json", 2},
		{"data-database-batch-boolean-system-mode-runtime.json", 1},
