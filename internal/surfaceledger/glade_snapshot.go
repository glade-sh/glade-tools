...
var fixtureBackedSystemAliasRows = []fixtureBackedSystemAliasRow{
	...
	{SurfaceID: "apex:System.FeatureManagement.checkPermission", Kind: KindMethod, Behavior: BehaviorSupported, Notes: "fixture-backed System-qualified alias for local FeatureManagement.checkPermission permission checks"},
